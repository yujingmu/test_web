...
class HomeLocator:
    ...
    changeable_bid1_locator = (By.XPATH, "//div[@class='b-unit'][1]//span[@class='fs-22']")
    changeable_bid2_locator = (By.XPATH, "//div[@class='b-unit'][2]//span[@class='fs-22']")
    changeable_bid3_locator = (By.XPATH, "//div[@class='b-unit'][3]//span[@class='fs-22']")
